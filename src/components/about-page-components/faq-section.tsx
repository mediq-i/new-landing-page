    ...
    <section className="py-20 px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs defaultValue="general" className="w-full">
          <TabsList className="flex flex-wrap justify-center h-auto bg-transparent mb-8 gap-2">
            {(Object.keys(faqData) as FaqCategory[]).map((category) => (
              <TabsTrigger
                key={category}
                value={category}
                className="px-6 py-2 rounded-full text-sm font-medium data-[state=active]:bg-primary data-[state=active]:text-white"
              >
